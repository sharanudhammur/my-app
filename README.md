...
13. ### What is a higher order function
    ...
    ```javascript
    function modifyValue(value, modifierFunction) {
    ...
    const result1 = modifyValue(3, addTwo); // Passes the addTwo function as an argument
    console.log(result1); // Outputs: 5
    
    const result2 = modifyValue(4, multiplyByFive); // Passes the multiplyByFive function
    console.log(result2); // Outputs: 20
